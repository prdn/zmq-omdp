...
Worker.prototype.onRequest = function(clientId, rid, data) {
	...
	var hash = clientId + rid; 
	this.req = { hash: hash, clientId: clientId, rid: rid, data: data };

    var reply = {
		active: function() {
			return self.req.hash == hash;
		},
