...
Worker.prototype.replyPartial = function(clientId, rid, data) {
    ...
    this.send([MDP.WORKER, MDP.W_REPLY_PARTIAL, clientId, rid, 200, data]);
	return true;
};
...
Worker.prototype.replyFinal = function(clientId, rid, data) {
    ...
    this.send([MDP.WORKER, MDP.W_REPLY, clientId, rid, 200, data]);
	return true;
};
...
Worker.prototype.replyError = function(clientId, rid, status, data) {
	...
	this.send([MDP.WORKER, MDP.W_REPLY, clientId, rid, status, data]);
	return true;
};
